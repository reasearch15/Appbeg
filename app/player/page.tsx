      ...
      >
        ...
        <section className="relative z-10 flex min-h-0 w-full min-w-0 flex-1 flex-col md:min-h-0">
          ...
          <div className="relative z-10 flex min-h-0 flex-1 flex-col">
            ...
            {/* PLAY VIEW */}
            {activeView === 'play' && <Play copyCredentialValue={copyCredentialValue} gameBackgroundImageByKey={gameBackgroundImageByKey} gameLogins={gameLogins} loadingList={loadingList} lowPerformanceMode={lowPerformanceMode} onCardsRendered={handlePlayCardsRendered} onShellRendered={handlePlayShellRendered} openActiveTableSplash={openActiveTableSplash} selectedGameName={selectedGameName} setSelectedGameName={setSelectedGameName} togglePassword={togglePassword} visiblePasswords={visiblePasswords} arbPlayerModeEnabled={arbPlayerModeEnabled} arbMode={arbMode} arbEnabled={arbEnabled} arbCooldownEndsAt={arbCooldownEndsAt} arbCanEnable={arbCanEnable} arbCanDisable={arbCanDisable} arbCanClaimBonusEvent={arbCanClaimBonusEvent} arbFeatureEnabled={arbFeatureEnabled} arbRiskBlocked={arbRiskBlocked} arbToggling={arbToggling} onArbToggle={handleArbToggle} arbPanelMessage={arbPanelMessage} />}
